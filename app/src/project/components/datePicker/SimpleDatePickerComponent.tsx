    ...
    function renderWeekdayRowForMonth(){
        ...
        for(let i = 0; i < amountDaysPerWeek; i++){
            ...
            output.push(
                ...
                <View style={{backgroundColor: backgroundColor, justifyContent: "center", alignItems: "center"}}>
                ...
                <TouchableOpacity
                    ...
                    style={[{justifyContent: "center", alignItems: "center", flex: 1}]}>
                        <Rectangle style={{width: "100%"}}>
                            <ViewPixelRatio style={[{borderRadius: "100%" ,width: "100%", justifyContent: "center", alignItems: "center", flex: 1, backgroundColor: "red"}, style]}>
