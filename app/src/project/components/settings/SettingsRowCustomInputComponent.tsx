...
export const SettingsRowCustomInputComponent: FunctionComponent<AppState> = (props) => {
  ...
  return (
      <SettingsRow expanded={editText} onPress={editText ? undefined : () => {if(!editText) {setEditText(!editText)}}} leftContent={description} rightContent={renderContent()} leftIcon={props?.icon} >
          {renderEditActions()}
      </SettingsRow>
  )
}
