...
import {Icon, RequiredStorageKeys, useSynchedState} from "kitcheningredients";
...
export const SettingsRowThemeSwitch: FunctionComponent = (props) => {
    ...
    return(
        <SettingsRowBooleanSwitch accessibilityLabel={accessibilityLabel} color={color} leftIcon={leftIcon} leftContent={<AppTranslation id={"theme"} />} onPress={handlePress} isChecked={isChecked} />
    )
}
