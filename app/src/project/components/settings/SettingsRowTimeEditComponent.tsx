...
export const SettingsRowTimeEditComponent: FunctionComponent<AppState> = (props) => {
  ...
  return (
          <SettingsRow accessibilityLabel={translationEdit+": "+description} onPress={editText ? undefined : () => {if(!editText) {setEditText(!editText)}}} leftContent={description} rightContent={renderContent()} leftIcon={props?.icon} />
  )
}
