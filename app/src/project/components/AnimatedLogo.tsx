...
import {ServerInfoHelper} from "kitcheningredients/lib/module/ignoreCoverage/KitchenHelper/helper/ServerInfoHelper";
					...
					<View style={{width: "100%", height: "100%", justifyContent: "center", alignItems: "center"}}>
						<View style={{width: "100%"}}>
							<View style={{marginBottom: "10%"}}>
								<Rectangle>
									<CrossLottie key={colorMode} source={source} flex={1} />
								</Rectangle>
							</View>
						</View>
					</View>
